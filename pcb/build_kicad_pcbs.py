...
def create_monture_pcb_36v(output_dir):
    ...
    # Connecteur vers PC (Centré à Y=85mm)
    ...
    pc_port.SetPosition(pcbnew.VECTOR2I(pcbnew.FromMM(142), pcbnew.FromMM(85 - 3.81)))
    board.Add(pc_port)
    add_label(board, "[ PC SERIAL ]", 124, 78.5, size_mm=0.8)
    add_label(board, "1: GND", 133, 81.2, size_mm=0.65)
    add_label(board, "2: +5V", 133, 83.7, size_mm=0.65)
    add_label(board, "3: RX",  134, 86.3, size_mm=0.65)
    add_label(board, "4: TX",  134, 88.8, size_mm=0.65)
