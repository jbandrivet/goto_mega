...
with open("goto_universal_raquette/teensy_raquette_v62/teensy_raquette_v62.ino", "r") as f:
    code = f.read()
...
with open("goto_universal_raquette/teensy_raquette_v62/teensy_raquette_v62.ino", "w") as f:
    f.write(code)
