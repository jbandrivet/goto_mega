...
const uint16_t EEPROM_ADDR_STEPS     = 28; 
const uint16_t EEPROM_ADDR_MICROSTEP = 32; 
const uint16_t EEPROM_ADDR_GEAR_AZ   = 34; 
const uint16_t EEPROM_ADDR_GEAR_ALT  = 42; 
const uint16_t EEPROM_ADDR_MOUNT_TYPE = 50; 
const uint16_t EEPROM_ADDR_BUZZER     = 51; 
const uint16_t EEPROM_ADDR_LATITUDE   = 52; 
const uint16_t EEPROM_ADDR_LONGITUDE  = 60; 
const uint16_t EEPROM_ADDR_REV_AZ     = 68; 
const uint16_t EEPROM_ADDR_REV_ALT    = 69; 
const uint16_t EEPROM_ADDR_PARK_ALT   = 70;
const uint16_t EEPROM_ADDR_PARK_AZ    = 78;
const uint16_t EEPROM_ADDR_DEROT_EN   = 86;
